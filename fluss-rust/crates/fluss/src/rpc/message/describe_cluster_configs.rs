...
impl RequestBody for DescribeClusterConfigsRequest {
    type ResponseBody = proto::DescribeClusterConfigsResponse;
    const API_KEY: ApiKey = ApiKey::DescribeClusterConfigs;
}

impl_write_type!(DescribeClusterConfigsRequest);
impl_read_type!(proto::DescribeClusterConfigsResponse);
