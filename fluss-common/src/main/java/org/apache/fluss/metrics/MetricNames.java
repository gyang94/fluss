...
public class MetricNames {
    ...
    public static final String REMOTE_UNREFERENCED_BYTES = "remoteUnreferencedBytes";
    public static final String REMOTE_UNREFERENCED_SEGMENT_COUNT = "remoteUnreferencedSegmentCount";
    public static final String REMOTE_ORPHAN_MANIFEST_COUNT = "remoteOrphanManifestCount";
